...
if($sql)
	echo "<script> alert('Data berhasil disimpan'); parent.location='kunjunganinput.php';</script>";
else
	echo "<script> alert('Data Gagal disimpan'); parent.location='kunjunganinput.php';</script>";
?>