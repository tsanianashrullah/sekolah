...
if($sql)
	echo "<script> alert('Data berhasil disimpan'); parent.location='dokterinput.php';</script>";
else
	echo "<script> alert('Data Gagal disimpan'); parent.location='dokterinput.php';</script>";
?>